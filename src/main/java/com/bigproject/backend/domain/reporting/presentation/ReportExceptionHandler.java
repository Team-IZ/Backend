...
/**
 * {@link ReportException}만 처리하는 어드바이스. global의 {@code GlobalExceptionHandler}는 손대지 않는다
 * ({@code OrganizationExceptionHandler}와 같은 구조).
 */
@Slf4j
...
public class ReportExceptionHandler {
	...
	public ResponseEntity<ReportErrorResponse> handleReportException(ReportException exception) {
		...
		return ResponseEntity
				...
				.body(ReportErrorResponse.of(exception.errorCode(), exception.getMessage()));
	}
}
