 ...
 */
@Schema(name = "RiskTraineeSort",
		description = "위험 교육생 비율 격자의 반·팀 행 정렬 기준. RECENT_ROUND_WORST(최근 발행 회차 나쁜 순) · "
				+ "WORSE_ROUND_COUNT(기준보다 나쁜 회차가 많은 순) · EXCLUSION_COUNT(미집계 많은 순) · NAME(이름순)",
		enumAsRef = true)
