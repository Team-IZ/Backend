...
@Schema(description = "오퍼레이터·매니저 초대 발송 결과. 초대 메일 발송 성공은 계정 활성화 완료를 의미하지 않습니다.")
public record InviteManagerResponse(
		...
		@Schema(description = "초대 대상 역할. 초대 경로별로 고정됩니다 — 매니저 초대는 MANAGER, 오퍼레이터 초대는 OPERATOR입니다.",
				allowableValues = {"OPERATOR", "MANAGER"}, example = "MANAGER") Role role,
		@Schema(description = "초대 발송 직후 계정 표시 상태", allowableValues = {"INVITED"}, example = "INVITED") AccountStatus status,
