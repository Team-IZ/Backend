...
public interface CohortRepository extends JpaRepository<Cohort, Long> {
    ...
    Optional<Cohort> findByCohortIdAndOrgIdAndDeletedAtIsNull(Long cohortId, Long orgId);

    /** 기관 내 동일 이름의 살아있는 기수 존재 여부 (기수명 중복 검사용) */
    boolean existsByOrgIdAndNameAndDeletedAtIsNull(Long orgId, String name);
    ...
    @Query("""
            ...
            """)
    Page<Cohort> findCohorts(@Param("orgId") Long orgId,
