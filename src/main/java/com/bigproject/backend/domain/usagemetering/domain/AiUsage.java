...
//	private UUID modelInstanceId;
	 ...
	 * AI가 무슨 기능을 수행했는지.
	 *
	 * <p>v07 {@code ck_ai_usage_feature_code} 기준. v06에서 이름이 바뀌고 하나가 둘로 갈라졌다.
	 * <ul>
	 *   <li>QUESTION_GENERATION → {@code CODE_SESSION}</li>
	 *   <li>ANSWER_GRADING → {@code ANSWER_EVALUATION}</li>
	 *   <li>SUMMARY_DRAFT → {@code INTERVIEW_BRIEF_GENERATION} · {@code REPORT_GENERATION} (2개로 분리)</li>
	 * </ul>
	 * 티어를 갖는 기능은 CODE_SESSION 하나뿐이다 — 나머지는 CHECK가 {@code tier_code}를 NULL로 강제한다.
	 */
	 ...
	 * 호출의 처리 대상 업무 엔터티 유형.
	 *
	 * <p>v07 {@code ck_ai_usage_context_type} 기준. v06의 CODE_SNAPSHOT·STAGE_ANSWER_ATTEMPT가 빠지고
	 * ANALYSIS_JOB·CODE_ANALYSIS·CURRICULUM_ANALYSIS·INTERVIEW_BRIEF·PROBLEM_STAGE·
	 * REPORT_GENERATION_ITEM·SUBMISSION이 추가됐다.
	 */
	public enum ContextType {
		ANALYSIS_JOB, ASSESSMENT_PROBLEM, ASSESSMENT_SESSION, CODE_ANALYSIS,
		CURRICULUM_ANALYSIS, CURRICULUM_VERSION, INTERVENTION, INTERVIEW_BRIEF,
		PROBLEM_STAGE, REPORT_GENERATION_ITEM, REPORT_SNAPSHOT, SUBMISSION
	}
