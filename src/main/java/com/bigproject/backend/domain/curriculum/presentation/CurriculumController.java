...
public class CurriculumController {
    ...
    @Operation(summary = "기수 연결 교안 목록", description = "**상태**: ✅ 사용 가능\n\n기관 범위의 활성 교안 버전 목록.")
    ...
    @Operation(summary = "쓰인 회차", description = "**상태**: ✅ 사용 가능\n\n이 교안 버전을 연결한 프로젝트들의 '미프 N차' 라벨 목록.")
    ...
    @Operation(
            summary = "비교 가능한 기수 목록",
            description = "**상태**: ✅ 사용 가능\n\n이 기수가 쓴 교안과 하나라도 겹치는 교안을 쓴 다른 기수 ID 목록."
    )
    ...
    @Operation(
            ...
            description = """
					**상태**: ✅ 사용 가능
					...
					교안의 재분석을 요청한다.
					⚠ 이 API는 요청만 접수한다. 실제 AI 분석 실행은 별도 워커가 담당하며, 이 응답 시점에는
					아직 섹션·검증개념이 갱신되지 않은 상태다.
					"""
    )
