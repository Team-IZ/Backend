...
public interface ProjectService {
    ...
    /**
     * GET /curricula/{id}/projects 용 — 이 교안 버전(curriculumVersionId)을 연결한 프로젝트들의
     * "미프 N차" 라벨 목록. project_curriculum 테이블 기반이라, findRoundLabelsUsingTeaches
     * (project_verification_concept 기반, 검증개념으로 확정된 것만)와는 다른 데이터 원천이다 —
     * 이쪽은 "연결"만 됐으면 포함되고, 검증개념 확정 여부는 안 본다.
     */
