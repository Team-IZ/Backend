...
/**
 * 티어 ↔ 모델 매핑 변경 요청. 목업 SA-03 ① `코드 세션 · 정확도 우선 / 균형 / 비용 우선` 3티어 매핑.
 *
 * <p>채점 모델과 달리 <b>재캘리브레이션이 필요 없다.</b> 코드 세션은 점수가 아니라 산출물이라
 * 버전 간 비교 문제가 생기지 않는다. 그래서 확인 모달도 요구하지 않는다.
 */
@Schema(description = "티어 ↔ 모델 매핑 변경 요청")
public record UpdateTierModelRequest(

		@Schema(description = "적용 기능. v07 기준 티어 선택 대상은 CODE_SESSION 하나뿐이다.", example = "CODE_SESSION")
		@NotNull
